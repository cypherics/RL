...
class CartpoleNonLinearQ:
    def __init__(self, alpha, eps, gamma, alpha_decay, eps_decay, max_train_iterations, max_test_iterations,
                 max_episode_length):
        self.alpha = alpha
        self.eps = eps
        self.gamma = gamma
...
if __name__ == '__main__':
    alg = CartpoleNonLinearQ(alpha=1e-03, eps=1, gamma=0.9, eps_decay=0.999, max_train_iterations=1000,
                             alpha_decay=0.999,
