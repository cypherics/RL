...
class CartpoleLinearQ:
  ...
  def compute_loss(self, state, action, reward, next_state, next_action, done):
    ...
    target_q = torch.argmax(self.model(next_state))
...
if __name__ == '__main__':
  alg = CartpoleLinearQ(alpha=1e-3, eps=1, gamma=0.9, eps_decay=0.999, max_train_iterations=1000, alpha_decay=0.999,
